...
class Graph:
    ...
    def __init__(self,vertices):
        self.V = vertices # inicializa o grafo ao atribuir um numero de vertices
        self.graph = [] # lista vazia para adicionar as arestas aos seus respetivos vertices e as guarda # default dictionary to store graph

    # funcao para adicionar uma aresta ao grafo
    def addEdge(self,u,v,w):
        self.graph.append([u,v,w])

    # funcao auxiliar para encontrar o conjunto a que um elemento pertence. Faz uso da tecnica path compression
    def find(self, parent, i):
        if parent[i] == i:
            return i
        return self.find(parent, parent[i])

    # funcao auxiliar para efetuar a uniao de dois subgrafos/conjuntos. Faz uso da tecnica union by rank
    ...
    def boruvkaMST(self):
        ...
        # Um array para guardar o indice da aresta de menor custo do subgrafo. Guarda o vertice, a aresta e o peso para cada componente
        ...
        while numTrees > 1:
            ...
            # Itera-se sobre todos as arestas e atualiza-se a aresta de custo minimo para todos os componentes
            for i in range(len(self.graph)):
                ...
                # Se as duas pontas da aresta atual pertencer 
                # ao mesmo conjunto, ignora-se a aresta atual. Caso nao,
                # verifica-se se a aresta atual e mais proxima das 
                # arestas anteriores de menor custo do conjunto 1 e
                # conjunto 2
